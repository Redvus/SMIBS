(function () {
    ...
    const navButtonMobile = document.getElementById("navButtonMobile"),
        ...
        navButtonLineMiddle = document.querySelector(
            ".nav-button-line__middle"
        ),
        navButtonLineBottom = document.querySelector(
            ".nav-button-line__bottom"
        ),
        ...
        $(".nav-main__children")
            ...
            .on("click", function (event) {
                ...
                $(this)
                    ...
                    .slideToggle(200)
                    .end()
                    .parent(".nav-main__children")
                    .siblings(".nav-main__children")
                    .children("a")
